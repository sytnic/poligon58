...
Происходит копированием с заменой папок со старого проекта. Почти все файлы Modified (изменения 5.7, внедренные в 5.8) отменяем, за исключением влияющих на проект (например, database\seeds\DatabaseSeeder.php). Все Unstaged (со старого проекта, новые созданные в проекте 5.7 файлы) коммитим.
- залить папку app
